//
//  DomicilioMiPedidoViewController.m
//  GoChef!
//
...
@implementation MiPedidoViewController
...
//#	Fecha Creación	: 07/04/2012  (pjoramas)
//#	Fecha Ult. Mod.	: 22/100/2012  (pjoramas)
//# Descripción		: 
//#
-(void) viewWillAppear:(BOOL)animated {
    ...
    self.navigationItem.title = @"Mi Pedido";
    ...
    // Posicionamos el principio
    [UITV_listado setContentOffset:CGPointMake(0.0f, 0.0f)];
}
...
-(void) addOffer {
    ...
    switch (globalVar.OC_order.OC_offer.TOT_typediscount)
    {
        ...
        case TOT_regalo_plato:
        {
            ...
            if      (globalVar.OC_order.TOT_type == TOT_pedido_a_domicilio)  [globalVar.TPVC_domicilio addValueGlobo:1];
            else if (globalVar.OC_order.TOT_type == TOT_pedido_para_recoger) [globalVar.TPVC_domicilio addValueGlobo:1];
            else if (globalVar.OC_order.TOT_type == TOT_pedido_antes_de_ir_al_restaurante) [globalVar.TPVC_antesllegar addValueGlobo:1];
...
-(void) redoOffer {
    ...
    switch (globalVar.OC_order.OC_offer.TOT_typediscount)
    {
        ...
        case TOT_regalo_plato:
        {
            ...
            // Actualizamos Tabbar Globe
            if      (globalVar.OC_order.TOT_type == TOT_pedido_a_domicilio)  [globalVar.TPVC_domicilio redoValueGlobo:1];
            else if (globalVar.OC_order.TOT_type == TOT_pedido_para_recoger) [globalVar.TPVC_domicilio redoValueGlobo:1];
            else if (globalVar.OC_order.TOT_type == TOT_pedido_antes_de_ir_al_restaurante) [globalVar.TPVC_antesllegar redoValueGlobo:1];
...
-(void) enviar_pedido_Touched {
    ...
    else if ([globalVar.OC_order.NSMA_orderfoods count] == 0) {
...
//# ------------------------------------------------------------------------------------------------------------
//#	Procedimiento   : select_oferta_Touched
//#	Fecha Creación	: 07/04/2012  (pjoramas)
//#	Fecha Ult. Mod.	: 11/06/2012  (pjoramas)
//# Descripción		: 
//#
